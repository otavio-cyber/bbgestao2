export default function WhatsAppFloat() {
  return (
    <a
      href="https://wa.me/5521969131553?text=Olá! Gostaria de saber mais sobre a BB Gestão."
      target="_blank"
    ...
    >
      ...
      <span className="font-display font-semibold text-sm hidden sm:block">WhatsApp</span>
    </a>
  )
}
